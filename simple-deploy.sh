...
echo ""
echo "   Settings come from wrangler.jsonc. VITE_SUPABASE_URL and"
echo "   VITE_SUPABASE_ANON_KEY are baked in at build time, so they"
echo "   need to be in .env before you run the build."
echo ""
echo "────────────────────────────────────────────────────────"
echo ""
